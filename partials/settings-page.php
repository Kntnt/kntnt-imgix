<div class="wrap">
  ...
  <form method="post">
              ...
              <?php switch ($field['type']):
                  case 'text': ?>
                    ...
                    <br>
                      <?php break; ?>
                  <?php case 'checkbox': ?>
                  <input id="<?php echo $id ?>" type="checkbox" name="<?php echo "{$ns}[$id]" ?>" value="1" <?php isset($values[$id]) ? checked($values[$id]) : ''; ?>>
                      <?php break; ?>
                  <?php case 'select': ?>
    ...
    <p class="submit">
      <input id="submit" class="button button-primary" type="submit" name="submit" value="<?php _e('Save Changes', 'kntnt-parallax-images'); ?>">
    </p>
  </form>
</div>
